...
namespace CrewDataSaveFixes
{
    ...
    internal class UpdateAvailableTalentsOnSpend
    {
        ...
        {
            if (PLServer.Instance.LatestSaveGameData != null && PLServer.Instance.LatestSaveGameData.ClassData[__instance.GetClassID()] != null  && inTalentID >= 0 && inTalentID < __instance.Talents.Length && PLServer.Instance.GetCachedFriendlyPlayerOfClass(__instance.GetClassID()) == __instance)
            {
